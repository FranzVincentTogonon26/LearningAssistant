...
export const generateQuiz = async ( req, res, next ) => {
    ...
    try {
        ...
        res.status(201).json({
            success: true,
            data: quiz,
            message: 'Quiz generated successufully'
        });
...
export const chat = async ( req, res, next ) => {
    ...
    try {
        ...
        // Generate response uaing Gemini
...
export const explainConcept = async ( req, res, next ) => {
    ...
    try {
        ...
        res.status(200).json({
            ...
            message: 'Explanation genearted successfully'
        });
...
export const getChatHistory = async ( req, res, next ) => {
    ...
    try {
        ...
        res.status(200).json({
            ...
            message: 'Chat history retrieved succesfully'
        });
