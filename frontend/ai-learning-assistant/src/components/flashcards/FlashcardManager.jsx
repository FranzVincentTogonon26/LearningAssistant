      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          <button 
            ...
            disabled={deleting}
            className="px-5 h-11 bg-slate-100 hover:bg-bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button 
            className="px-5 h-11 bg-linear-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
