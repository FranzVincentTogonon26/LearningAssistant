...
const QuizResultPage = () => {
  ...
  return (
    ...
    {/* Score Card */}
    <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 basis-8">
      <div className="text-center space-y-6">
        ...
        <div className="flex items-center justify-center gap-4 pt-4">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-xl">
            ...
            <span className="text-sm font-semibold text-emerald-700">{correctAnswers} Incorrect</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 bg-rose-50 border border-rose-200 rounded-xl">
            <XCircle className='w-4 h-4 text-rose-700' strokeWidth={2} />
