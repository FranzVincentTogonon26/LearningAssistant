...
const DocumentListPage = () => {
  ...
  const fetchDocuments = async () => {
    try{
      ...
      toast.error('Failed to fecth documents');
      console.error(error);
    } finally {
      setLoading(false);
    }
  ...
  const handleUpload = async (e) => {
    ...
    try{
      ...
      toast.success('Document uploaded succcesfully.');
      ...
      return (
        <div className="flex items-center justify-center min-h-100">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-slate-500 mb-6">Get started bu uploading your first PDF document to begin learning.</p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                <input
                  ...
                  accept='.pdf'
                />
                <div className="flex flex-col items-center jsutify-center py-10 px-6">
                  <div className="w-14 h-14 rounded-xl bg-linear-to-r from-emerald-100 to-teal-100 flex items-center justify-center mb-4">
                    <Upload className='w-7 h-7 text-emerald-700' strokeWidth={2} />
                  </div>
